...
export PRAETOR_PATH="${PRAETOR_PATH:-/home/$PRAETOR_USER/.local/share/praetor}"
export PRAETOR_PRIVATE="${PRAETOR_PRIVATE:-/home/$PRAETOR_USER/.local/share/praetor-private}"
